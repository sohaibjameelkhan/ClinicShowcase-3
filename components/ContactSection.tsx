      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <h3 className="text-xl font-semibold mb-8 text-white">Connect with me on social media</h3>
            <div className="flex justify-center space-x-6">
              <a 
                href="https://www.linkedin.com/in/muhammad-sohaib-jameel-36478a1b0/" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/sohaibk5" 
                target="_blank" 
                rel="noopener noreferrer"
